...
<head>
  ...
  <title>BrightShoeCare | <?= $section ?> </title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top p-3 shadow">
    <div class="container">
        <a class="navbar-brand font-weight-bold title" href="<?= base_url('') ?>">BrightShoeCare</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ml-auto">
                ...
                <a class="nav-item nav-link font-weight-bold <?= ($hal == 'tarif') ? 'active' : ''; ?>" href="<?= base_url('tarif') ?>">Layanan</a>
                <a class="nav-item nav-link font-weight-bold <?= ($hal == 'cari') ? 'active' : ''; ?>" href="<?= base_url('cari') ?>">Lacak</a>
                <a class="nav-item nav-link font-weight-bold <?= ($hal == 'kontak') ? 'active' : ''; ?>" href="<?= base_url('kontak') ?>">Kontak</a>
                <a class="btn btn-primary ml-3" href="<?= base_url('pelanggan/masuk') ?>">Masuk</a>
            </div>
        </div>
    </div>
</nav>
      ...
      <div class="row">
        <div class="col-lg-6 h-100 text-center text-lg-left my-auto text-white">
          <ul class="list-inline mb-2 ">
            ...
            <li class="list-inline-item">
              <a href="<?= base_url('tarif') ?>" class="text-light font-weight-bold">Layanan</a>
            </li>
            <li class="list-inline-item">&sdot;</li>
            <li class="list-inline-item">
          ...
          <p class="text-white small mb-4 mb-lg-0">&copy; BrightShoeCare 2024. All Rights Reserved.</p>
        </div>
